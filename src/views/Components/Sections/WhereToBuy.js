...
export default function WhereToBuy() {
    ...
    return (
        ...
        <div className={classes.container}>
            ...
            <p>Actually you cannot buy IDA tokens yet, but you have opportunity to exchange again another exciting ERC20 tokens. there is a coupple places where you can get IDA tokens, visit decentralized exchange devethswap. swap any exiting token to IDA.</p>
            <GridContainer>
                ...
                <p className="text-white font-size-21 m-0">VISIT IDAHWALLET </p>
                </GridItem>
            </GridContainer>
        </div>
        </div>
